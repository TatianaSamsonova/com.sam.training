 ...
 */
public class BackextensionManager extends GeneratedBackextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(BackextensionManager.class.getName());
	 ...
	 */
	public static BackextensionManager getInstance()
	{
		return (BackextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BackextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BackextensionManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BackextensionManager called.");
		}
	}
